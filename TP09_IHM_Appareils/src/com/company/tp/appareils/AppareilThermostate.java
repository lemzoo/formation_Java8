...
public class AppareilThermostate extends AppareilElectrique {
	...
	public void setValeurThermostat(int pThermostat) {
		...
		if(valeurThermostatDemandee <= iThermostatMax && valeurThermostatDemandee>=0){
	...
	/**
	 * Method decrementeThermostat() permet de décrementer de -1 
	 * l'aiguille du thermostat
	 *  
	 * @author Lamine BA
	 */
	...
	/**
	 * Methode arreter( ) permet d'arrêter l'appareil thermostat et 
	 * de remettre la valeur du thermostat à zero. 
	 */
	public void arreter(){
		this.iThermostat = 0;
		this.isEnMarche = false;
		System.out.println("Arret de l'appareil");
	}
