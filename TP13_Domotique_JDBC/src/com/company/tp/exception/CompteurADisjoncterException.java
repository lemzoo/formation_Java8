 ...
 * la puissance demandée sur un compteur.
 * @author Lamine BA
 *
 */
public class CompteurADisjoncterException extends Exception {
	...
	public String toString(){
		...
		chaine = sMessageException + "\n" + 
				"----------------\n" + 
				"La Marque du compteur en cause : " + compteurEnCause.getMarque() + "\n" + 
				"Le Modèle du compteur en cause : " + compteurEnCause.getModele() + "\n" + 
				"La Puissance Max du compteur en cause : " + compteurEnCause.getMaxWatts() + "\n" + 
				"La Puissance demandée est : " + iPuissanceDemandee;
